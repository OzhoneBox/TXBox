...
def mainlist(item):
    ...
    itemlist.append(item.clone( title = '  Canales con Idiomas', action = 'ch_groups', group = 'languages' ))
    itemlist.append(item.clone( title = '  Canales con Años', action = 'ch_groups', group = 'years' ))
    itemlist.append(item.clone( title = '  Canales con Épocas', action = 'ch_groups', group = 'epochs' ))
    itemlist.append(item.clone( title = '  Canales con Países', action = 'ch_groups', group = 'countries' ))
    itemlist.append(item.clone( title = '  Canales con Calidades', action = 'ch_groups', group = 'qualityes' ))
    ...
    itemlist.append(item.clone( title = '  Canales con Audio solo en Castellano', action = 'ch_groups', group = 'cast' ))
    itemlist.append(item.clone( title = '  Canales con Audio solo en Latino', action = 'ch_groups', group = 'lat' ))
    itemlist.append(item.clone( title = '  Canales con Audio solo en Versión original subtitulada', action = 'ch_groups', group = 'vose' ))
    itemlist.append(item.clone( title = '  Canales con Audio solo en Versión original', action = 'ch_groups', group = 'vo' ))
