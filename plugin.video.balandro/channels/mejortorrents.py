...
host = 'https://www.mejortorrento.info'
...
def do_downloadpage(url, post=None, headers=None):
    ...
    url = url.replace('//www.mejortorrento.com', '//www.mejortorrento.info')
    url = url.replace('//www.mejortorrento.net', '//www.mejortorrento.info')
