...
def do_downloadpage(url, post=None, headers=None):
    ...
    url = url.replace('/dontorrents.org/', '/dontorrents.lol/')
    url = url.replace('/dontorrents.net/', '/dontorrents.lol/')
    url = url.replace('/dontorrent.one/', '/dontorrents.lol/')
    url = url.replace('/dontorrent.app/', '/dontorrents.lol/')
