...
def mainlist_pelis(item):
    ...
    itemlist.append(item.clone( title = 'Catálogo', action = 'list_all', url = url_api + 'facts/index?limit=48&offset=0' ))

    itemlist.append(item.clone( title = 'Por canal', action = 'categorias', url = url_api + 'tags/top', group = 'chs' ))
    itemlist.append(item.clone( title = 'Por categoría', action = 'categorias', url = url_api + 'tags/top', group = 'cats' ))
